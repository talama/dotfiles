...
local normal_mappings = {
	...
	["\\"] = { "<Plug>(comment_toggle_blockwise_current)", "Comment toggle blockwise" },
	-- general
	["c"] = { "<cmd>Bdelete<cr>", "Close Buffer" },
	["q"] = { "<cmd>lua require('talama.utils').smart_quit()<cr>", "Quit" },
...
local visual_mappings = {
	...
	["\\"] = { "<Plug>(comment_toggle_blockwise_visual)", "Comment toggle blockwise" },
	["y"] = { '"+y', "yank to clipboard" },
	["d"] = { '"_d', "Delete to void register" },
	["p"] = "which_key_ignore",
}
